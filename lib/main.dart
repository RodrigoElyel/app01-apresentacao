        ...
        child: Container(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                Image.network(
                  "https://avatars.githubusercontent.com/u/37051453?v=4",
                  width: screenWidth * 1,
                ...
                const Row(
                  ...
                  children: [
                    ...
                    Text("Rodrigo Elyel Costa Batista", style: customStyle),
                  ],
                ),
                const Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    SizedBox(
                        width: 8), // Add some spacing between the icon and text
                    Text("Desenvolvedor de Software", style: customStyle),
                  ],
                ),
                const Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    SizedBox(
                        width: 8), // Add some spacing between the icon and text
                    Text("IFPI - 2023111EPDMD0049", style: customStyle),
                  ],
                ),
                const Row(
                  mainAxisAlignment: MainAxisAlignment.center,
